...
{blank}
+
Try again your query after setting a longer timeout with the command below:
+
[source, subs=]
----
tt 8080-tcp<br>
...
NOTE: *Ignore* the following notification when _Quarkus_ starts: +
`A new process is now listening on port 5005 ...`
