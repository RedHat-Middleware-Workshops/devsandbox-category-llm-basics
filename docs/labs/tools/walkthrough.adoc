...
[custom] Adding Quarkus OpenShift dependency...
[custom] Excluding (Snakeyaml) artifact (compilation conflict)...
...
// pass:[<b style="text-align: center"><b>Camel JBang</b>] 
...
--
📁 llm-basics/camel/tools/lab +
pass:[<mark style="padding-left: 2rem; background-color: white; color: red"><b>&nbsp;📁&nbsp;</b></mark>] .mvn +
pass:[<mark style="padding-left: 2rem; background-color: white; color: red"><b>&nbsp;📁&nbsp;</b></mark>] src +
pass:[<mark style="padding-left: 2rem; background-color: white; color: red"><b>&nbsp;↟&nbsp;</b></mark>] mvnw +
pass:[<mark style="padding-left: 2rem; background-color: white; color: blue"><b>&nbsp;❖</b></mark>] mvnw.cmd +
pass:[<mark style="padding-left: 2rem; background-color: white; color: red"><b>&nbsp;↟&nbsp;</b></mark>] pom.xml +
...
NOTE: You don't need to run the application locally, jump to the next section (Deployment) if you prefer save some time. But it's nice to run the application and check all is in its place.
...
Open the Dev Spaces dashboard following the actions below: 

//styling for keyboard keys
pass:a[<style>{style-kbd}</style>]

. Open the Command Pallette in VSCode using the following keyboard combination:
- Mac: kbd:[&nbsp;⇧&nbsp; + ⌘ + P]
- Linux: kbd:[Ctrl+Shift+P]
- Windows: kbd:[Ctrl+Shift+P]
. Click the button _Copy to clipboard_
...
// pass:[<b style="background-color=white;color=grey">Ctrl</b> + <kbd>C</kbd>]
